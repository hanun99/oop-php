...
if(isset($_POST['add_to_cart'])){
   ...
   if(mysqli_num_rows($select_cart) > 0){
      ...
      mysqli_query($conn, "INSERT INTO carts(user_id, name, price, image, quantity) VALUES('$user_id', '$product_name', '$product_price', '$product_image', '$product_quantity')") or die('query failed');
      echo "<script>
...
if(isset($_POST['update_cart'])){
   ...
   mysqli_query($conn, "UPDATE `carts` SET quantity = '$update_quantity' WHERE id = '$update_id'") or die('query failed');
   echo "<script>
            ...
            <h1 class="heading">Latest <span>Products</span></h1>
               <div class="box-container" style="grid-template-columns: repeat(auto-fit, minmax(370px, auto)); gap: 2rem; align-items: center; margin-bottom: 100px; margin-top: 3rem;">
                  ...
                  <form method="post" class="box" action="">
                     <img src="img/<?php echo $fetch_product['image']; ?>" alt="" style="width: 245px; height: 178px; padding-right: 15px;">
                     <h2 class="name"><?php echo $fetch_product['name']; ?></h2>
                     <h3 class="price">Rp<?php echo $fetch_product['price']; ?>/-</h3>
               ...
               <tr>
                  ...
                  <td>
                     <form action="" method="post">
                        ...
                        <input type="number" min="1" name="cart_quantity" value="<?php echo $fetch_cart['quantity']; ?>" style="padding: 5px; border: none; border-radius: 5px; width: 60px;">
                        <input type="submit" name="update_cart" value="update" class="option-btn" style="color: black; background-color: orange; border: none; padding: 5px; border-radius: 5px;">
                     </form>
                  </td>
