...
<?php
    ...
    mysqli_query($koneksi,$query_k_del);
    
    $query_k = "INSERT into nilai_k (k) VALUES ('$kvall') ";
    mysqli_query($koneksi,$query_k);
    ...
    if($result AND $result2) {
        $banyak_data = mysqli_result($result,0);
        ...
        $banyak_data2 = mysqli_result($result2,0);
        //Mendapatkan total data training
        //echo ("Berapa total training: $banyak_data2");
        $query_data2 = "SELECT * FROM data_testing";
        $result_data2 = mysqli_query($koneksi,$query_data2);
    }

    //Mendapatkan total kolom data training
    $jmlh_kolom = mysqli_num_fields($result_data);
    ...
    for($i=0;$i<$banyak_data2;$i++){
        ...
        for($j=0;$j<$banyak_data;$j++){
            ...
            for($z=2; $z<$jmlh_kolom-1;$z++){
                ...
                $data_train = mysqli_result($result_data,$j,$z);
                //Mendapatkan fitur data testing
                $data_test = mysqli_result($result_data2,$i,$z);
                //echo("$data_test");
        ...
        for($k=0;$k<$banyak_data;$k++){
            ...
            for($l=0;$l<$kvall;$l++){
                ...
                $id = mysqli_result($result_data,$k,0);
